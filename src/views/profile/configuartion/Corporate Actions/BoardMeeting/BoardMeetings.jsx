...
function BoardMeetings() {
  ...
  const handleCreate = async () => {
    ...
    if(date<= 3){
      ...
      alert('Please Enter Agenda Details')
        ...
        await axios.post('https://board-meetings.onrender.com/config/board_meeting/add', {
          companyName,
          date,
          agenda,
        })
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete('https://board-meetings.onrender.com/config/board_meeting/' + id)
  ...
  const getApi = async () => {
    await axios
      .get('https://board-meetings.onrender.com/config/board_meeting/get-all')
      .then((response) => {
